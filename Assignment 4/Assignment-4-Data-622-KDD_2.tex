...
\urlstyle{same}
\hypersetup{
  pdftitle={Data 622 Assignment 4},
...
\pandocbounded{\includegraphics[keepaspectratio]{Assignment-4-Data-622-KDD_2_files/figure-pdf/unnamed-chunk-4-1.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{Assignment-4-Data-622-KDD_2_files/figure-pdf/unnamed-chunk-4-2.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{Assignment-4-Data-622-KDD_2_files/figure-pdf/unnamed-chunk-4-3.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{Assignment-4-Data-622-KDD_2_files/figure-pdf/unnamed-chunk-4-4.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Assignment-4-Data-622-KDD_2_files/figure-pdf/unnamed-chunk-4-5.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{Assignment-4-Data-622-KDD_2_files/figure-pdf/unnamed-chunk-4-6.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{Assignment-4-Data-622-KDD_2_files/figure-pdf/unnamed-chunk-4-7.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Assignment-4-Data-622-KDD_2_files/figure-pdf/unnamed-chunk-4-8.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{Assignment-4-Data-622-KDD_2_files/figure-pdf/unnamed-chunk-4-9.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{Assignment-4-Data-622-KDD_2_files/figure-pdf/unnamed-chunk-4-10.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Assignment-4-Data-622-KDD_2_files/figure-pdf/unnamed-chunk-4-11.pdf}}
...
\CommentTok{\#impute the original dataset with predicitve mean matching}
\NormalTok{X }\OtherTok{\textless{}{-}}\NormalTok{ fulldata[}\FunctionTok{sapply}\NormalTok{(fulldata, is.numeric)] }
\NormalTok{imputed }\OtherTok{\textless{}{-}} \FunctionTok{mice}\NormalTok{(X, }\AttributeTok{m =} \DecValTok{1}\NormalTok{, }\AttributeTok{method =} \StringTok{"pmm"}\NormalTok{, }\AttributeTok{maxit =} \DecValTok{5}\NormalTok{) }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{X }\OtherTok{\textless{}{-}} \FunctionTok{complete}\NormalTok{(imputed)}

\CommentTok{\#data scaled }
\NormalTok{X\_scaled }\OtherTok{\textless{}{-}} \FunctionTok{scale}\NormalTok{(X)}
\CommentTok{\#back to data frame}
\NormalTok{X }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(X\_scaled)}
\NormalTok{X}\SpecialCharTok{$}\NormalTok{Potability }\OtherTok{=}\NormalTok{ fulldata}\SpecialCharTok{$}\NormalTok{Potability }
\CommentTok{\#remove outliers}
\NormalTok{md }\OtherTok{\textless{}{-}}  \FunctionTok{mahalanobis}\NormalTok{(X\_scaled, }\FunctionTok{colMeans}\NormalTok{(X\_scaled), }\FunctionTok{cov}\NormalTok{(X\_scaled)) }
\NormalTok{outliers }\OtherTok{\textless{}{-}} \FunctionTok{which}\NormalTok{(md }\SpecialCharTok{\textgreater{}} \FunctionTok{qchisq}\NormalTok{(}\FloatTok{0.975}\NormalTok{, }\AttributeTok{df=}\FunctionTok{ncol}\NormalTok{(X\_scaled))) }
\NormalTok{outliers}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#data without outliers, and is scaled and imputed.}

\NormalTok{clean\_data }\OtherTok{\textless{}{-}}\NormalTok{ X[}\SpecialCharTok{{-}}\NormalTok{outliers, ]}
\NormalTok{clean\_data }\OtherTok{\textless{}{-}} \FunctionTok{na.omit}\NormalTok{(clean\_data)}
\NormalTok{clean\_data}\SpecialCharTok{$}\NormalTok{Potability }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(clean\_data}\SpecialCharTok{$}\NormalTok{Potability, }\AttributeTok{levels =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{))}
\NormalTok{clean\_data}\SpecialCharTok{$}\NormalTok{Potability }\OtherTok{\textless{}{-}} \FunctionTok{relevel}\NormalTok{(clean\_data}\SpecialCharTok{$}\NormalTok{Potability, }\AttributeTok{ref =} \StringTok{"1"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{clean\_train\_data }\OtherTok{\textless{}{-}}\NormalTok{ clean\_data[train\_index, ]}
\NormalTok{clean\_test\_data }\OtherTok{\textless{}{-}}\NormalTok{ clean\_data[}\SpecialCharTok{{-}}\NormalTok{train\_index, ]}

\NormalTok{clean\_train\_data }\OtherTok{\textless{}{-}} \FunctionTok{na.omit}\NormalTok{(clean\_train\_data)}
\NormalTok{clean\_test\_data }\OtherTok{\textless{}{-}} \FunctionTok{na.omit}\NormalTok{(clean\_test\_data)}
...
\NormalTok{clean\_data}\SpecialCharTok{$}\NormalTok{Potability }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(clean\_data}\SpecialCharTok{$}\NormalTok{Potability, }\AttributeTok{levels =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{))}
\NormalTok{clean\_train\_data}\SpecialCharTok{$}\NormalTok{Potability }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(clean\_train\_data}\SpecialCharTok{$}\NormalTok{Potability, }\AttributeTok{levels =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{))}

\NormalTok{clean\_test\_data}\SpecialCharTok{$}\NormalTok{Potability }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(clean\_test\_data}\SpecialCharTok{$}\NormalTok{Potability, }\AttributeTok{levels =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{))}


\CommentTok{\#making 1  the positive class}
...
\CommentTok{\#making 1  the positive class}
\NormalTok{clean\_data}\SpecialCharTok{$}\NormalTok{Potability }\OtherTok{\textless{}{-}} \FunctionTok{relevel}\NormalTok{(clean\_data}\SpecialCharTok{$}\NormalTok{Potability, }\AttributeTok{ref =} \StringTok{"1"}\NormalTok{)}
\NormalTok{clean\_train\_data}\SpecialCharTok{$}\NormalTok{Potability }\OtherTok{\textless{}{-}} \FunctionTok{relevel}\NormalTok{(clean\_train\_data}\SpecialCharTok{$}\NormalTok{Potability, }\AttributeTok{ref =} \StringTok{"1"}\NormalTok{)}
\NormalTok{clean\_test\_data}\SpecialCharTok{$}\NormalTok{Potability }\OtherTok{\textless{}{-}} \FunctionTok{relevel}\NormalTok{(clean\_test\_data}\SpecialCharTok{$}\NormalTok{Potability, }\AttributeTok{ref =} \StringTok{"1"}\NormalTok{)}

\NormalTok{same\_rows }\OtherTok{\textless{}{-}} \FunctionTok{intersect}\NormalTok{(clean\_train\_data, test\_data)}
\NormalTok{n\_same }\OtherTok{\textless{}{-}} \FunctionTok{nrow}\NormalTok{(same\_rows)}
\NormalTok{n\_same}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#removal of features}
\CommentTok{\#clean\_test\_data \textless{}{-} clean\_test\_data |\textgreater{} dplyr::select({-}Trihalomethanes, {-}Conductivity, {-} Turbidity, {-} Organic\_carbon)}

\CommentTok{\#clean\_train\_data \textless{}{-} clean\_train\_data |\textgreater{} dplyr::select({-}Trihalomethanes, {-}Conductivity, {-} Turbidity, {-} Organic\_carbon)}
\end{Highlighting}
\end{Shaded}
...
\pandocbounded{\includegraphics[keepaspectratio]{Assignment-4-Data-622-KDD_2_files/figure-pdf/unnamed-chunk-8-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Assignment-4-Data-622-KDD_2_files/figure-pdf/unnamed-chunk-8-2.pdf}}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#Potability should not be scaled}
\NormalTok{num\_cols }\OtherTok{\textless{}{-}} \FunctionTok{sapply}\NormalTok{(train\_data, is.numeric) }
\NormalTok{num\_cols[}\StringTok{"Potability"}\NormalTok{] }\OtherTok{\textless{}{-}} \ConstantTok{FALSE} 

\CommentTok{\#scale all the columns except potability}
\NormalTok{train\_scaled\_vals }\OtherTok{\textless{}{-}} \FunctionTok{scale}\NormalTok{(train\_data[, num\_cols])}

\CommentTok{\#apply the scale from the training data to the test data}
\NormalTok{train\_center }\OtherTok{\textless{}{-}} \FunctionTok{attr}\NormalTok{(train\_scaled\_vals, }\StringTok{"scaled:center"}\NormalTok{) }\CommentTok{\#pull out the center of the scaled data}
\NormalTok{train\_scale }\OtherTok{\textless{}{-}} \FunctionTok{attr}\NormalTok{(train\_scaled\_vals, }\StringTok{"scaled:scale"}\NormalTok{) }\CommentTok{\#apply the scaling factor}

\CommentTok{\#scale the test data using the scaling from the train data}
\NormalTok{test\_scaled\_vals }\OtherTok{\textless{}{-}} \FunctionTok{scale}\NormalTok{(test\_data[, num\_cols], }\AttributeTok{center =}\NormalTok{ train\_center, }\AttributeTok{scale =}\NormalTok{ train\_scale)}

\CommentTok{\#add the potability column back to training data and scale data }
\NormalTok{train\_scaled }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(train\_scaled\_vals, }\AttributeTok{Potability =}\NormalTok{ train\_data}\SpecialCharTok{$}\NormalTok{Potability)}

\NormalTok{test\_scaled }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(test\_scaled\_vals, }\AttributeTok{Potability =}\NormalTok{ test\_data}\SpecialCharTok{$}\NormalTok{Potability)}

\CommentTok{\#checking the distributions to see that they are on the same scale.}

\NormalTok{numeric\_scaled\_long }\OtherTok{\textless{}{-}}\NormalTok{ train\_scaled  }\SpecialCharTok{|\textgreater{}}\NormalTok{ dplyr}\SpecialCharTok{::}\FunctionTok{select}\NormalTok{(}\SpecialCharTok{{-}}\NormalTok{Potability) }\SpecialCharTok{|\textgreater{}} 
  \FunctionTok{pivot\_longer}\NormalTok{(}\AttributeTok{cols =} \FunctionTok{everything}\NormalTok{(), }\AttributeTok{names\_to =} \StringTok{"Variable"}\NormalTok{, }\AttributeTok{values\_to =} \StringTok{"Value"}\NormalTok{) }


\CommentTok{\#distributions on the same scale}
\FunctionTok{ggplot}\NormalTok{(numeric\_scaled\_long, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Variable, }\AttributeTok{y =}\NormalTok{ Value)) }\SpecialCharTok{+}
\FunctionTok{geom\_violin}\NormalTok{(}\AttributeTok{fill =} \StringTok{"skyblue"}\NormalTok{, }\AttributeTok{color =} \StringTok{"black"}\NormalTok{) }\SpecialCharTok{+}
  \CommentTok{\#scale\_y\_continuous(limits = c(0, 500)) +}
\FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{""}\NormalTok{,}
\AttributeTok{x =} \StringTok{""}\NormalTok{,}
...
\pandocbounded{\includegraphics[keepaspectratio]{Assignment-4-Data-622-KDD_2_files/figure-pdf/unnamed-chunk-8-3.pdf}}

\subsection{}\label{section-3}

\subsection{Imputation}\label{imputation}

Medians from training data set used to impute the training (dirty) and
test data set
...
\pandocbounded{\includegraphics[keepaspectratio]{Assignment-4-Data-622-KDD_2_files/figure-pdf/unnamed-chunk-12-1.pdf}}
...
\NormalTok{  Potability }\SpecialCharTok{\textasciitilde{}}\NormalTok{ ., }
  \AttributeTok{data =}\NormalTok{ train\_data, }\CommentTok{\#not scaled}
...
\pandocbounded{\includegraphics[keepaspectratio]{Assignment-4-Data-622-KDD_2_files/figure-pdf/unnamed-chunk-16-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Assignment-4-Data-622-KDD_2_files/figure-pdf/unnamed-chunk-17-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Assignment-4-Data-622-KDD_2_files/figure-pdf/unnamed-chunk-19-1.pdf}}

\begin{verbatim}
\end{verbatim}

\subsection{Random Forest with cleaner
data}\label{random-forest-with-cleaner-data}
...
\NormalTok{rf\_model }\OtherTok{\textless{}{-}} \FunctionTok{randomForest}\NormalTok{(}
\NormalTok{  Potability }\SpecialCharTok{\textasciitilde{}}\NormalTok{ ., }
  \AttributeTok{data =}\NormalTok{ clean\_train\_data,}
  
  \AttributeTok{ntree =} \DecValTok{500}\NormalTok{,}
  \AttributeTok{importance =} \ConstantTok{TRUE}
\NormalTok{)}

\NormalTok{forrest\_pred\_class }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(rf\_model, clean\_test\_data, }\AttributeTok{type =} \StringTok{"class"}\NormalTok{)}
\NormalTok{forrest\_pred\_prob }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(rf\_model, clean\_test\_data, }\AttributeTok{type =} \StringTok{"prob"}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#table(Predicted = forrest\_pred\_class, Actual = test\_data$Potability)}

\CommentTok{\#mean(forrest\_pred\_class == test\_data$Potability)}

\NormalTok{cm }\OtherTok{\textless{}{-}} \FunctionTok{confusionMatrix}\NormalTok{(forrest\_pred\_class, clean\_test\_data}\SpecialCharTok{$}\NormalTok{Potability)}
...
\pandocbounded{\includegraphics[keepaspectratio]{Assignment-4-Data-622-KDD_2_files/figure-pdf/unnamed-chunk-20-1.pdf}}
...
\subsection{Adaboost with ``clean''
data}\label{adaboost-with-clean-data}
...
\NormalTok{ada\_pred }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(ada\_model, clean\_test\_data)}

\NormalTok{ada\_pred}\SpecialCharTok{$}\NormalTok{class }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(}
\NormalTok{  ada\_pred}\SpecialCharTok{$}\NormalTok{class,}
  \AttributeTok{levels =} \FunctionTok{levels}\NormalTok{(clean\_test\_data}\SpecialCharTok{$}\NormalTok{Potability)}
\NormalTok{)}

\NormalTok{cm }\OtherTok{\textless{}{-}} \FunctionTok{confusionMatrix}\NormalTok{(ada\_pred}\SpecialCharTok{$}\NormalTok{class, clean\_test\_data}\SpecialCharTok{$}\NormalTok{Potability)}
...
\NormalTok{train\_center }\OtherTok{\textless{}{-}} \FunctionTok{attr}\NormalTok{(train\_scaled\_vals, }\StringTok{"scaled:center"}\NormalTok{)}
\NormalTok{train\_scale }\OtherTok{\textless{}{-}} \FunctionTok{attr}\NormalTok{(train\_scaled\_vals, }\StringTok{"scaled:scale"}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{rbf\_pred\_class }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(SVM\_rbf\_model, test\_scaled, }\AttributeTok{type =} \StringTok{"response"}\NormalTok{)}
...
\NormalTok{cm }\OtherTok{\textless{}{-}} \FunctionTok{confusionMatrix}\NormalTok{(rbf\_pred\_class, test\_scaled}\SpecialCharTok{$}\NormalTok{Potability)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{rbf\_pred\_class }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(SVM\_rbf\_model, clean\_test\_data, }\AttributeTok{type =} \StringTok{"response"}\NormalTok{)}
...
\NormalTok{cm }\OtherTok{\textless{}{-}} \FunctionTok{confusionMatrix}\NormalTok{(rbf\_pred\_class, clean\_test\_data}\SpecialCharTok{$}\NormalTok{Potability)}
...
\pandocbounded{\includegraphics[keepaspectratio]{Assignment-4-Data-622-KDD_2_files/figure-pdf/unnamed-chunk-29-1.pdf}}
...
\NormalTok{  Potability }\SpecialCharTok{\textasciitilde{}}\NormalTok{ ., }
  ...
  \AttributeTok{kernel =} \StringTok{"rbfdot"}\NormalTok{, }\AttributeTok{C =}\NormalTok{ x}
\NormalTok{)}
\NormalTok{  rbf\_pred }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(SVM\_rbf\_model, clean\_test\_data, }\AttributeTok{type =} \StringTok{"response"}\NormalTok{)}
  \CommentTok{\#agree \textless{}{-} ifelse(rbf\_pred == eqtest\_data$term\_deposit\_factor, 1, 0)}
  \CommentTok{\#accuracy \textless{}{-}  sum(agree) / nrow(eqtest\_data)}
  
\NormalTok{   cm }\OtherTok{\textless{}{-}} \FunctionTok{confusionMatrix}\NormalTok{(rbf\_pred, clean\_test\_data}\SpecialCharTok{$}\NormalTok{Potability)}
...
\pandocbounded{\includegraphics[keepaspectratio]{Assignment-4-Data-622-KDD_2_files/figure-pdf/unnamed-chunk-31-1.pdf}}

\subsection{Logistic Regression}\label{logistic-regression}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lmodel }\OtherTok{\textless{}{-}} \FunctionTok{glm}\NormalTok{(}
\NormalTok{  Potability }\SpecialCharTok{\textasciitilde{}}\NormalTok{.,}
  \AttributeTok{data =}\NormalTok{ train\_scaled,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{log\_pred\_class }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(lmodel, test\_scaled)}

\NormalTok{log\_pred\_class }\OtherTok{\textless{}{-}} \FunctionTok{ifelse}\NormalTok{(pred\_prob }\SpecialCharTok{\textgreater{}=} \FloatTok{0.5}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{)}
\NormalTok{log\_pred\_class }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(pred\_class, }\AttributeTok{levels =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{))}
...
\NormalTok{cm }\OtherTok{\textless{}{-}} \FunctionTok{confusionMatrix}\NormalTok{(log\_pred\_class, test\_scaled}\SpecialCharTok{$}\NormalTok{Potability)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{clean\_train\_data}\SpecialCharTok{$}\NormalTok{Potability }\OtherTok{\textless{}{-}} \FunctionTok{as.numeric}\NormalTok{(}\FunctionTok{as.character}\NormalTok{(clean\_train\_data}\SpecialCharTok{$}\NormalTok{Potability))}
\NormalTok{clean\_test\_data}\SpecialCharTok{$}\NormalTok{Potability  }\OtherTok{\textless{}{-}} \FunctionTok{as.numeric}\NormalTok{(}\FunctionTok{as.character}\NormalTok{(clean\_test\_data}\SpecialCharTok{$}\NormalTok{Potability))}


\CommentTok{\#num\_cols \textless{}{-} sapply(train\_data, is.numeric)}

\CommentTok{\#train\_scaled \textless{}{-} train\_data}
\CommentTok{\#test\_scaled  \textless{}{-} test\_data}

\CommentTok{\#train\_scaled \textless{}{-} scale(train\_data[,num\_cols])}

\CommentTok{\#train\_center \textless{}{-} attr(train\_scaled, "scaled:center")}
\CommentTok{\#train\_scale \textless{}{-} attr(train\_scaled, "scaled:scale")}

\CommentTok{\#test\_scaled \textless{}{-} scale(test\_data,}
\CommentTok{\#  center = train\_center,}
\CommentTok{\#  scale  = train\_scale}
\CommentTok{\#)}
...
\NormalTok{neural\_prob }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(neural\_model, clean\_test\_data) [,}\DecValTok{1}\NormalTok{]}
...
\NormalTok{cm }\OtherTok{\textless{}{-}} \FunctionTok{confusionMatrix}\NormalTok{(neural\_class, clean\_test\_data}\SpecialCharTok{$}\NormalTok{Potability)}
...
\pandocbounded{\includegraphics[keepaspectratio]{Assignment-4-Data-622-KDD_2_files/figure-pdf/unnamed-chunk-36-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Assignment-4-Data-622-KDD_2_files/figure-pdf/unnamed-chunk-37-1.pdf}}
